    ...
    _initGL() {
      ...
      const fsSource = `
        ...
        void main(){
          ...
          // Apply a premium frosted glass grain noise overlay
          float noiseVal = (random(v_uv * (sin(u_time) + 2.0)) - 0.5) * 0.015;
          final.rgb += noiseVal;
    ...
    async captureSnapshot() {
      ...
      const attemptCapture = async (
        ...
        try {
          ...
          this.snapshotTarget.classList.add("liquid-capturing");
          undos.push(() => this.snapshotTarget.classList.remove("liquid-capturing"));
